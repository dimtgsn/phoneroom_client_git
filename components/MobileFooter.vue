<template>
  <div>
    <div class="items">
      <div class="line item_line"></div>
      <div ref="item1">
        <div class="item-wrapp"  @click="openItem(item1)">
          <h3 class="item_name title">Покупателям</h3>
        ...
        <div id="item" class="items_content">
          <div class="item">
            <div class="item_body">
              <ul class="client_ul footer_ul">
                <nuxt-link to="#">
                ...
                <nuxt-link to="#">
                  <li class="footer_link footer_link-last">
                    Кредит и рассрочка
                  </li>
                </nuxt-link>
              </ul>
      ...
      <div ref="item2" >
        <div class="item-wrapp" @click="openItem(item2)">
          <h3 class="item_name title">Доставка и оплата</h3>
          <div class="block-arrow">
            <svg id="arrow" class="arrow" width="2rem" height="0.875rem" viewBox="0 0 32 14" fill="none">
              <path d="M1.5 12.5L16 1.5L30.5 12.5" stroke="#858FA4" stroke-width="2"/>
            </svg>
      ...
      <div ref="item3" >
        <div class="item-wrapp" @click="openItem(item3)">
          <h3 class="item_name title">О компании</h3>
          <div class="block-arrow">
            <svg id="arrow" class="arrow" width="2rem" height="0.875rem" viewBox="0 0 32 14" fill="none">
              <path d="M1.5 12.5L16 1.5L30.5 12.5" stroke="#858FA4" stroke-width="2"/>
            </svg>
      ...
      <div ref="item4" >
        <div class="item-wrapp" @click="openItem(item4)">
          <h3 class="item_name title">Обратная связь</h3>
          <div class="block-arrow">
            <svg id="arrow" class="arrow" width="2rem" height="0.875rem" viewBox="0 0 32 14" fill="none">
              <path d="M1.5 12.5L16 1.5L30.5 12.5" stroke="#858FA4" stroke-width="2"/>
            </svg>
        ...
        <div id="item" class="items_content">
          <div class="item">
            <div class="item_body">
              <h3 class="footer_link">Контакты</h3>
              <ul class="contact_ul footer_ul">
                <a href="tel:+78000000000"  target="_blank">
                  <li class="footer_link"><span class="white">+7 (800) 000-00-00</span> по России</li>
                </a>
                <nuxt-link to="#">
                  <span class="footer_link white">info@phone-room.ru</span>
                  <li class="footer_link white footer_link-last">Написать</li>
                </nuxt-link>
              </ul>
            </div>
          </div>
...
<!--      <div class="line item_line"></div>-->
      ...
      <div class="line footer_icons_line"></div>
...
const openItem = (item) => {
  ...
  const itemBody = item.querySelector("#item");
  console.log(item);
  itemBody.classList.toggle("item_active");
};
</script>
