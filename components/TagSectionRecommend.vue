<template>
  <section class="tag-section">
    <div class="container">
      <h2 class="tag_title title">Рекомендуем</h2>
    </div>
    <div class="container-fluid">
      ...
      <div v-else>
        <div v-if="tagRec" class="product-section">
          ...
          prevEl: '.swiper-button-prev',
            ...
            <SwiperSlide class="tag-new-cards"  v-for="product in tagRec.products">
...
const urlRec = computed(() => config.public.apiBaseUrl + `tags/${props.slug}`);

const { pending, data: tagRec } = await useLazyAsyncData("tagRec", () => $fetch(urlRec.value));
